...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002466539494 -1002480100918 -1002281694959')).split()]  # For Multiple Id Use One Space Between Each.
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = True
URL = environ.get("URL", "https://open-charmain-umesh4q4w6-bfa27389.koyeb.app/")
